...
public static class ValidationErrors
{
    ...
    {
        public static Error DescriptionIsRequired => 
            new("CreatePost.DescriptionIsRequired", "The description is required.");
        
        public static Error TitleIsRequired => 
            new("CreatePost.TitleIsRequired", "The title is required.");

        public static Error AuthorIdIsRequired => 
            new("CreatePost.AuthorIdIsRequired", "The author identifier is required.");
